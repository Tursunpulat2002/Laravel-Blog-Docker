...
Next, navigate in your terminal to the directory you cloned this, and spin up the containers for the web server by running `docker-compose up -d --build app`. Then run `docker-compose run --rm artisan migrate`.
